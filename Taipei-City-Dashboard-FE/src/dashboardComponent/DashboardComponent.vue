...
import LongTermCareText from "./components/LongTermCareText.vue";
import NhiEmergencyChart from "./components/NhiEmergencyChart.vue";
import NhiEmergencyDonutChart from "./components/NhiEmergencyDonutChart.vue";
import NhiEmergencyChartSvg from "./assets/chart/BarChart.svg";
...
function returnChartComponent(name, svg) {
	switch (name) {
		...
		case "LongTermCareText":
			return svg ? TextUnitChartSvg : LongTermCareText;
		case "NhiEmergencyChart": //test
			return svg ? NhiEmergencyChartSvg : NhiEmergencyChart;
		case "NhiEmergencyDonutChart":
			return svg ? DonutChartSvg : NhiEmergencyDonutChart;
		default:
			return svg ? MapLegendSvg : MapLegend;
	}
}
